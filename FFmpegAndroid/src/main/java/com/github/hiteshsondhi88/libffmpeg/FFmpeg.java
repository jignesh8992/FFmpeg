...
import com.github.hiteshsondhi88.libffmpeg.asynctasks.FFmpegExecuteAsyncTask;
import com.github.hiteshsondhi88.libffmpeg.asynctasks.FFmpegLoadLibraryAsyncTask;
import com.github.hiteshsondhi88.libffmpeg.exceptions.FFmpegCommandAlreadyRunningException;
import com.github.hiteshsondhi88.libffmpeg.exceptions.FFmpegNotSupportedException;
import com.github.hiteshsondhi88.libffmpeg.interfaces.FFmpegExecuteResponseHandler;
import com.github.hiteshsondhi88.libffmpeg.interfaces.FFmpegInterface;
...
public class FFmpeg implements FFmpegInterface {
    ...
    private FFmpeg(Context context) {
        ...
        Log.setDEBUG(FFmpegUtils.isDebug(this.context));
    }
    ...
    public void loadBinary(FFmpegLoadBinaryResponseHandler ffmpegLoadBinaryResponseHandler) throws FFmpegNotSupportedException {
        ...
        if (!TextUtils.isEmpty(cpuArchNameFromAssets)) {
            ffmpegLoadLibraryAsyncTask = new FFmpegLoadLibraryAsyncTask(context,
                    cpuArchNameFromAssets, ffmpegLoadBinaryResponseHandler);
    ...
    @Override
    public void execute(Map<String, String> environvenmentVars, String[] cmd, float duration,
                        FFmpegExecuteResponseHandler ffmpegExecuteResponseHandler) throws FFmpegCommandAlreadyRunningException {
        ...
        if (cmd.length != 0) {
            ...
            ffmpegExecuteAsyncTask = new FFmpegExecuteAsyncTask(command, timeout,
                    ffmpegExecuteResponseHandler, duration);
    ...
    @Override
    public void execute(String[] cmd, float duration,
                        FFmpegExecuteResponseHandler ffmpegExecuteResponseHandler) throws FFmpegCommandAlreadyRunningException {
        execute(null, cmd, duration, ffmpegExecuteResponseHandler);
    }
    ...
    public String getDeviceFFmpegVersion() throws FFmpegCommandAlreadyRunningException {
        ...
        CommandResult commandResult =
                shellCommand.runWaitFor(new String[]{FileUtils.getFFmpeg(context), "-version"});
    ...
    public boolean killRunningProcesses() {
        return FFmpegUtils.killAsync(ffmpegLoadLibraryAsyncTask) || FFmpegUtils.killAsync(ffmpegExecuteAsyncTask);
    }
