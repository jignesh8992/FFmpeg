...
public interface FFmpegInterface {
     ...
     */
    public void execute(Map<String, String> environvenmentVars, String[] cmd,float duration, FFmpegExecuteResponseHandler ffmpegExecuteResponseHandler) throws FFmpegCommandAlreadyRunningException;
     ...
     * @throws FFmpegCommandAlreadyRunningException
     */
    public void execute(String[] cmd,float duration ,FFmpegExecuteResponseHandler ffmpegExecuteResponseHandler) throws FFmpegCommandAlreadyRunningException;
