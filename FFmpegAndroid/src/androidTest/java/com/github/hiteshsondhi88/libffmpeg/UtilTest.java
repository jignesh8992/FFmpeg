...
public class UtilTest extends CommonTestCase {
    ...
    public void testCloseInputStream() throws Exception {
        ...
        FFmpegUtils.close(stubInputStream);
    ...
    public void testCloseOutputStream() throws Exception {
        ...
        FFmpegUtils.close(stubOutputStream);
    ...
    public void testConvertInputStreamToString() throws Exception {
        ...
        String output1 = FFmpegUtils.convertInputStreamToString(stream1);
        String output2 = FFmpegUtils.convertInputStreamToString(stream2);
        String output3 = FFmpegUtils.convertInputStreamToString(stream3);
    ...
    public void testDestroyProcessAndIsProcessCompleted() throws Exception {
        ...
        assertEquals(false, FFmpegUtils.isProcessCompleted(process));
        ...
        Future<?> future = executor.submit(new Runnable() {
            @Override
            public void run() {
                String errorStream = FFmpegUtils.convertInputStreamToString(process.getErrorStream());
                String inputStream = FFmpegUtils.convertInputStreamToString(process.getInputStream());
    ...
    public void testKillAsync() throws Exception {
        ...
        asyncTask.execute();
        assertEquals(true, FFmpegUtils.killAsync(asyncTask));
    }
}